    ...
    <div class="content">
      <div class="imgContainer">
        <div class="bigimg">
          <ul class="item_big_img_list">
            <li class="item_big_good"  v-for="item in goodInfo.img" :key="item._id">
      ...
      <div class="simg">
        <ul class="item_small_img_list">
            <li class="item_small_good"  v-for="(item,index) in goodInfo.img" :key="item._id" @click="choiceImg(index)">
...
export default {
  ...
  data() {
    return {
      ...
      goodInfo:null, //通过goodId从后端获取到的sp信息
...
.ginfo{width: 500px;height: 400px;border:1px solid grey;}
.gname{margin-top:30px;}
.gprice{color:red;}
select{width:70px;}
