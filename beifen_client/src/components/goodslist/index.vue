...
<ul class="goods_list">
    ...
    <li class="goods_item">
        <div class="goods">
            <div><img class="goods_img" src="@/assets/sofa2.jpg" /></div>
            <div class="goods_name" title="椅子沙发洗衣机椅子沙发洗衣机椅子沙发洗衣机">
                椅子沙发洗衣机
                椅子沙发洗衣机椅子沙发洗衣机
            </div>
            <div class="goods_price">999</div>
            <div class="buyOrCart">
                <div class="buy"></div>
    ...
    <li class="goods_item">
        <div class="goods">
            <div><img class="goods_img" src="@/assets/sofa2.jpg" /></div>
            <div class="goods_name" title="椅子沙发洗衣机椅子沙发洗衣机椅子沙发洗衣机">椅子沙发洗衣机
                椅子沙发洗衣机椅子沙发洗衣机
            </div>
            <div class="goods_price">999</div>
            <div class="buyOrCart">
    ...
    <li class="goods_item" @mouseenter="buttonEnter">
...
activated(){
var query=this.$route.params.smallSort
...
*{margin:0;padding:0}
.main{width: 100%;}
.goods_list{width: 90%;display: flex;margin:0 auto;flex-wrap:wrap}
.goods_item{width: 20%;}
